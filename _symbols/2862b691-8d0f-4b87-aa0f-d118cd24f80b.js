...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(ul, "class", "items svelte-xkf5gw");
		},
		m(target, anchor) {
...
// (240:12) {#each item.links as {link}}
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(h3, "class", "title svelte-xkf5gw");
			attr(div0, "class", "description svelte-xkf5gw");
			attr(div1, "class", "links svelte-xkf5gw");
			attr(li, "class", "svelte-xkf5gw");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button0, "class", button0_class_value = "web " + (/*activeTab*/ ctx[1] === 'websites' ? 'active' : '') + " svelte-xkf5gw");
			attr(button1, "class", button1_class_value = "webapp " + (/*activeTab*/ ctx[1] === 'webApps' ? 'active' : '') + " svelte-xkf5gw");
			attr(button2, "class", button2_class_value = "word " + (/*activeTab*/ ctx[1] === 'wordpress' ? 'active' : '') + " svelte-xkf5gw");
			attr(div0, "class", "tabs cont svelte-xkf5gw");
		...
		p(ctx, [dirty]) {
			if (dirty & /*activeTab*/ 2 && button0_class_value !== (button0_class_value = "web " + (/*activeTab*/ ctx[1] === 'websites' ? 'active' : '') + " svelte-xkf5gw")) {
				attr(button0, "class", button0_class_value);
			}

			if (dirty & /*activeTab*/ 2 && button1_class_value !== (button1_class_value = "webapp " + (/*activeTab*/ ctx[1] === 'webApps' ? 'active' : '') + " svelte-xkf5gw")) {
				attr(button1, "class", button1_class_value);
			}

			if (dirty & /*activeTab*/ 2 && button2_class_value !== (button2_class_value = "word " + (/*activeTab*/ ctx[1] === 'wordpress' ? 'active' : '') + " svelte-xkf5gw")) {
